...
public class AlunoResource {
    ...
    public Response inserirRs(Aluno aluno, @Context UriInfo uriInfo) throws SQLException, ClassNotFoundException {
    ...
    @Path("/{rm}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response deletarRs(@PathParam("rm") int rm) throws SQLException, ClassNotFoundException {
